...
router.post('/loginverify', async (req, res, next) => {
    ...
    resultValidate.then(
        function(result){
            ...
            console.log('inside resolve ' + result.finFacturacion);

            res.send('finally inside resolve');

            /*console.log('ruc ' + result.ruc);
            console.log('nombre empresa ' + result.nombre);
            console.log('fecha fin facturacion ' + result.finFacturacion);*/
