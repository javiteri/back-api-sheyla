...
exports.loginValidateEmpresaAndUser = function(ruc, user, password){
    ...
    return new Promise((resolve, reject) => {
        ...
        try{
            ...
            let queryInsertUserDefaultEmpresa = `INSERT INTO usuarios (usu_empresa_id, usu_nombres,usu_username, usu_password, usu_permiso_escritura) VALUES (?,?,?,?,?)`;
                                ...
                                connection.query(queryInsertEmpresa, [ruc, "Nueva Empresa", fechaActual], function(err, resultsEmpresa){
                                    ...
                                    if(err) {
                                        ...
                                        connection.query(queryInsertUserDefaultEmpresa, 
                                            [resultsEmpresa.insertId, 'Usuario Default', user, password, 1], function(err, resultsUser){
