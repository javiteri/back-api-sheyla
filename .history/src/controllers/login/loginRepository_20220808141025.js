                    ...
                    poolMysql.getConnection(function(err, connection){
                        ...
                        connection.beginTransaction(function(error){
                            if(error){
                                ...
                                connection.query(queryInsertEmpresa, [ruc, "Nueva Empresa", new Date()], function(err, results){

                                    if(err) {
                                        connection.rollbackonn.rollback(function(){ connection.release()});
                                        console.log('error insertando base de datos');
                                    } else {
